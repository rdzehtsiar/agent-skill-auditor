...
pub use model::{
    ...
    CompatibilityMatrix, DependencyManifestEvidence, DependencyManifestPinningKind,
    EvidenceConfidence, ExecutableArtifact, ExecutableKind, ExternalUrl, ExternalUrlKind,
    FindingCategory, FindingConfidence, FindingEvidenceSample, FindingGroup, FindingLocation,
    LicenseEvidence, LicenseScope, LockfileEvidence, MarkdownCodeBlock, OfflineDependencyEvidence,
    ...
    RemoteDependency, RemoteDependencyKind, RuntimeOfflineCapability,
    RuntimeOfflineCapabilityStatus, ScanReport, Severity, SkillArtifactKind, SkillCompatibilityRow,
